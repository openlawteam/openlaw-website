          ...
          <Wrap>
            <div className={`${f.row} ${s.flexWrapper}`}>
              <div className={`${s.legalProtocolWrapper}`} key="1">
                <div
                  className={`${f.column} ${s.textHeading}`}
                  key="1.1"
                  data-aos="fade-up"
                  data-aos-delay="450"
                >
                  ...
                  <Text>
                    Blockchains are transforming the way commercial
                    relationships are structured and executed, bringing
                    increased operational efficiencies.
                  </Text>
                  <Text>
                    Putting together a blockchain-based application is
                    cumbersome, expensive, and inefficient. We make building
                    those applications a snap.
                  </Text>
                  <button
