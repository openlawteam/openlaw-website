    ...
    return (
      <Wrap>
        <div className={`${s.flexWrapper} ${f.row}`}>
          ...
          <div
            className={`${f.column} ${s.svgWrapper}`}
            key="1"
            data-aos="fade-up"
            data-aos-delay="450"
          >
            ...
            <Text>
              Create a private environment. Sign up in minutes and create a
              private blockchain-based environment for your team.
            </Text>
            <button onClick={this.goToSignUp} className={`${s.button} button`}>
              Sign Up
            </button>
            <br />
            <a
            ...
            >
              Undecided? Talk to an expert <CaretRightSVG />
            </a>
          </div>
        </div>
      </Wrap>
