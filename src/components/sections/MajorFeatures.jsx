      ...
      <Wrap>
        <div className={`${s.flexWrapper} ${f.row}`}>
          <div className={`${f.column} ${s.svgWrapper}`} key="1" data-aos="fade-up" data-aos-delay="150">
            ...
            <Text>Check out our library of <a href="https://app.openlaw.io/templates"><strong>legal templates</strong></a> generated by our fast-growing community.</Text>
          </div>

          <div className={`${f.column} ${s.svgWrapper}`} key="2" data-aos="fade-up" data-aos-delay="300">
            <div className={`${s.svgDiv}`}>
              <AutomateSVG />
            </div>
            <H2>Automate</H2>
            <div className={s.divider}></div>
            <Text>Automatically transfer digital assets via smart contracts.</Text>
          </div>
